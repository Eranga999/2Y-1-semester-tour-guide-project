...
<body>
	<section class="header">
		...
		<nav class="navbar">
			...
			<form action="Package_readServlet" method="post">
				<input type="submit" value="Package" class="nna">
			</form>


			<a href="guide.jsp">Guides</a> <a href="about.jsp">About</a> <a
				href="review.jsp">Review</a>
			<div class="dropdown">
				<button class="dropbtn">
					<i></i>Admins
				</button>
				<div class="dropdown-content">
					<a href="#">Admin</a> <a href="PackageLogin.jsp">Package
						Manager</a>
	...
	<div class="heading"
		style="background: url(images/img23.jpg) no-repeat">
		<h1>Package control</h1>
	</div>

	<section class="pack">
		<h1 class="heading-title">package discount</h1>
		<form name="new-pack" action="DiscountinsertServlet" method="post"
			class="new-pack" onsubmit="validationForm2()">
			<div class="flex">
				<div class="inputbox">
					<Span>discount rate</Span> <input type="number"
						placeholder="enter discount rate" name="rate">
				</div>

				<div class="inputbox">
					<Span>select tour type:</Span> <select name="package_type"
						id="package_type">
				...
				<div class="inputbox">
					<Span>generate discount code</Span> <input type="text"
						placeholder="enter discount code" name="code">
				</div>
