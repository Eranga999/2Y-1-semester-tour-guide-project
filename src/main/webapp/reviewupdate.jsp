   ...
   <div class="container">
    ...
    %>
      ...
      <div class="container d-flex justify-content-center">
         <form action="Reviewupdateservlet" method="post" style="width:50vw; min-width:300px;">
            <div class="row mb-3">
               <div class="col">
            ...
            <div>
               ...
               <a href="aboutus.jsp" class="btn btn-danger">Cancel</a>
            </div>
         </form>
      </div>
   </div>
