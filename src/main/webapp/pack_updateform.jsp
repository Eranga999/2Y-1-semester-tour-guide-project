...
<section class="pack">
    <h1 class="heading-title">update the package</h1>
    <%
    ...
    %>
<form name="newform" action="Package_updateServlet" method="post" class="new-pack" onsubmit="validateForm1()" >
    <div class="flex">
        <div class="inputbox">
        ...
        <div class="inputbox">
            ...
            <input type="number" value="<%= idpackage %>" name="idpackage" readonly>
        </div>
        ...
        <div class="inputbox">
            ...
            <textarea name="details" rows="6" cols="75"><%= details %></textarea>
        </div>
    </div>
    <input type="submit" name="send" class="btn" value="update">
</form>
